...
_ssize_t (*_term_write_p)(const void *buf, size_t bytes) = _term_write; // BUG -- should be null_term_write;
_ssize_t (*_error_write_p)(const void *buf, size_t bytes) = _error_write; // BUG -- should be null_term_write;
