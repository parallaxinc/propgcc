/*
 * f_printf.c: this stands for "full" printf or "float" printf,
 * depending on your interpretation; anyway, it means a full
...
static int
_doprnt (char const *fmt, va_list ap)
{
#define PUTC(c) { _putc (c); ++retval; }
