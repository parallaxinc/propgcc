To install, copy the propgcc directory to the root directory of the C drive.
Open a command prompt window and go into the propgcc directory.
Run the batch file addpath to add the bin directories to the PATH.
