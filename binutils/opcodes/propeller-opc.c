...
/* nop      ------ ---- cccc --------- --------- */
  {"nop", 0x00000000, 0x003c0000, PROPELLER_OPERAND_IGNORE, NR, PROP_1 | PROP_2, COMPRESS_MACRO, 0x00},
...
/* brs      100000 zcri cccc ddddddddd sssssssss */
  {"brs", 0x80000000, 0xfc000000, PROPELLER_OPERAND_BRS, R, PROP_1_LMM | PROP_2_LMM, COMPRESS_BRL, 0},
  /* dummy entry for the disassembler only */
  {"brs ", 0x84800000, 0xfc800000, PROPELLER_OPERAND_BRS, R, PROP_1_LMM | PROP_2_LMM, COMPRESS_BRL, 0},

/* ldi is a fake instruction built from a rdlong and a constant that decodes as NOP */
/* ldi      000010 zc1i cccc ddddddddd sssssssss */
  {"ldi", 0x08800000, 0xfc800000, PROPELLER_OPERAND_LDI, R, PROP_1_LMM | PROP_2_LMM, NO_COMPRESSED, 0},

/* brw is also made of rdlong and a constant.  We may shrink it later. */
/* brw       000010 zc1i cccc ddddddddd sssssssss */
  {"brw", 0x08800000, 0xfc800000, PROPELLER_OPERAND_BRW, R, PROP_1_LMM | PROP_2_LMM, NO_COMPRESSED, 0},
...
/* fcache is a jmp followed by a 32 bit constant */
  {"fcache", 0x1c000000, 0xffffffff, PROPELLER_OPERAND_FCACHE, NR, PROP_2_LMM, COMPRESS_MACRO, MACRO_FCACHE},
...
/* mvi expands to a jmp followed by a 32 bit constant, just like fcache */
  {"mvi", 0x1c000000, 0xffffffff, PROPELLER_OPERAND_MVI, NR, PROP_2_LMM, COMPRESS_MVI, PREFIX_MVI},
...
/* mviw expands to a jmp followed by a 32 bit constant, just like fcache */
  {"mviw", 0x1c000000, 0xffffffff, PROPELLER_OPERAND_MVI, NR, PROP_2_LMM, COMPRESS_MVIW, PREFIX_MVIW},
...
/* lcall expands to a jmp followed by a 32 bit constant, just like fcache */
  {"lcall", 0x1c000000, 0xffffffff, PROPELLER_OPERAND_LCALL, NR, PROP_2_LMM, COMPRESS_MACRO, MACRO_LCALL},

/* lcall expands to a jmp followed by a 32 bit constant, just like fcache */
  {"lret", 0x5c800000, 0xffffffff, PROPELLER_OPERAND_MACRO_0, NR, PROP_1_LMM, COMPRESS_MACRO, MACRO_RET},
  {"lret", 0x1c800000, 0xffffffff, PROPELLER_OPERAND_MACRO_0, NR, PROP_2_LMM, COMPRESS_MACRO, MACRO_RET},
  {"lmul", 0x5c800000, 0xffffffff, PROPELLER_OPERAND_MACRO_0, NR, PROP_1_LMM, COMPRESS_MACRO, MACRO_MUL},
  {"lmul", 0x1c800000, 0xffffffff, PROPELLER_OPERAND_MACRO_0, NR, PROP_2_LMM, COMPRESS_MACRO, MACRO_MUL},
  {"ludiv", 0x5c800000, 0xffffffff, PROPELLER_OPERAND_MACRO_0, NR, PROP_1_LMM, COMPRESS_MACRO, MACRO_UDIV},
  {"ludiv", 0x1c800000, 0xffffffff, PROPELLER_OPERAND_MACRO_0, NR, PROP_2_LMM, COMPRESS_MACRO, MACRO_UDIV},
  {"ldiv", 0x5c800000, 0xffffffff, PROPELLER_OPERAND_MACRO_0, NR, PROP_1_LMM, COMPRESS_MACRO, MACRO_DIV},
  {"ldiv", 0x1c800000, 0xffffffff, PROPELLER_OPERAND_MACRO_0, NR, PROP_2_LMM, COMPRESS_MACRO, MACRO_DIV},

/* pushm and popm expand to a mov followed by a jmpret */
/* push and pop      101000 zcri cccc ddddddddd sssssssss */
  {"lpushm", 0xa0000000, 0xffffffff, PROPELLER_OPERAND_MACRO_8, R, PROP_1_LMM | PROP_2_LMM, COMPRESS_MACRO, MACRO_PUSHM},
  {"lpopm", 0xa0000000, 0xffffffff, PROPELLER_OPERAND_MACRO_8, R, PROP_1_LMM | PROP_2_LMM, COMPRESS_MACRO, MACRO_POPM},
  {"lpopret", 0xa0000000, 0xffffffff, PROPELLER_OPERAND_MACRO_8, R, PROP_1_LMM | PROP_2_LMM, COMPRESS_MACRO, MACRO_POPRET},
...
/* leasp      101000 zcri cccc ddddddddd sssssssss */
  {"leasp", 0xa0000000, 0xffffffff, PROPELLER_OPERAND_LEASP, R, PROP_1_LMM | PROP_2_LMM, COMPRESS_MACRO, PREFIX_LEASP},
...
/* wrbyte   000000 000i cccc ddddddddd sssssssss */
  {"wrbyte", 0x00000000, 0xff800000, PROPELLER_OPERAND_PTRS_OPS, NR, PROP_2, COMPRESS_XOP, XOP_WRB},
...
/* rdbyte   000000 z01i cccc ddddddddd sssssssss */
  {"rdbyte", 0x00800000, 0xfd800000, PROPELLER_OPERAND_PTRS_OPS, R, PROP_2, NO_COMPRESSED, 0},
/* rdbytec   000000 z11i cccc ddddddddd sssssssss */
  {"rdbytec", 0x01800000, 0xff800000, PROPELLER_OPERAND_PTRS_OPS, R, PROP_2, NO_COMPRESSED, 0},
...
/* wrword   000001 000i cccc ddddddddd sssssssss */
  {"wrword", 0x04000000, 0xff800000, PROPELLER_OPERAND_TWO_OPS, NR, PROP_2, NO_COMPRESSED, 0},
...
/* rdword   000001 001i cccc ddddddddd sssssssss */
  {"rdword", 0x04800000, 0xff800000, PROPELLER_OPERAND_PTRS_OPS, R, PROP_2, NO_COMPRESSED, 0},
/* rdwordc   000001 z11i cccc ddddddddd sssssssss */
  {"rdwordc", 0x05800000, 0xff800000, PROPELLER_OPERAND_PTRS_OPS, R, PROP_2, NO_COMPRESSED, 0},
...
/* wrlong   000010 000i cccc ddddddddd sssssssss */
  {"wrlong", 0x08000000, 0xff800000, PROPELLER_OPERAND_PTRS_OPS, NR, PROP_2, NO_COMPRESSED, 0},
...
/* rdlong   000010 z01i cccc ddddddddd sssssssss */
  {"rdlong", 0x08800000, 0xff800000, PROPELLER_OPERAND_PTRS_OPS, R, PROP_2, NO_COMPRESSED, 0},
...
/* cogid    000011 zcr1 cccc ddddddddd 000000001 */
  {"cogid", 0x0c400001, 0xfc4001ff, PROPELLER_OPERAND_DEST_ONLY, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* coginit  000011 zcR1 cccc ddddddddd 000000010 */
  {"coginit", 0x0c400002, 0xfc4001ff, PROPELLER_OPERAND_DEST_ONLY, NR, PROP_1, NO_COMPRESSED, 0},
/* cogstop  000011 zcR1 cccc ddddddddd 000000011 */
  {"cogstop", 0x0c400003, 0xfc4001ff, PROPELLER_OPERAND_DEST_ONLY, NR, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* locknew  000011 zcr1 cccc ddddddddd 000000100 */
  {"locknew", 0x0c400004, 0xfc4001ff, PROPELLER_OPERAND_DEST_ONLY, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* lockret  000011 zcR1 cccc ddddddddd 000000101 */
  {"lockret", 0x0c400005, 0xfc4001ff, PROPELLER_OPERAND_DEST_ONLY, NR, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* lockset  000011 zcR1 cccc ddddddddd 000000110 */
  {"lockset", 0x0c400006, 0xfc4001ff, PROPELLER_OPERAND_DEST_ONLY, NR, PROP_1 | PROP_2, NO_COMPRESSED, 0},
...
/* rol      001001 zcri cccc ddddddddd sssssssss */
  {"rol", 0x24000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* shr      001010 zcri cccc ddddddddd sssssssss */
  {"shr", 0x28000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, COMPRESS_XOP, XOP_SHR},
/* shl      001011 zcri cccc ddddddddd sssssssss */
  {"shl", 0x2c000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, COMPRESS_XOP, XOP_SHL},
/* rcr      001100 zcri cccc ddddddddd sssssssss */
  {"rcr", 0x30000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* rcl      001101 zcri cccc ddddddddd sssssssss */
  {"rcl", 0x34000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* sar      001110 zcri cccc ddddddddd sssssssss */
  {"sar", 0x38000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, COMPRESS_XOP, XOP_SAR},
/* rev      001111 zcri cccc ddddddddd sssssssss */
  {"rev", 0x3c000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* mins     010000 zcri cccc ddddddddd sssssssss */
  {"mins", 0x40000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* maxs     010001 zcri cccc ddddddddd sssssssss */
  {"maxs", 0x44000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* min      010010 zcri cccc ddddddddd sssssssss */
  {"min", 0x48000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* max      010011 zcri cccc ddddddddd sssssssss */
  {"max", 0x4c000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* movs     010100 zcri cccc ddddddddd sssssssss */
  {"movs", 0x50000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* movd     010101 zcri cccc ddddddddd sssssssss */
  {"movd", 0x54000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* movi     010110 zcri cccc ddddddddd sssssssss */
  {"movi", 0x58000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
...
/* jmp      000111 zc0i cccc --------- sssssssss *//* These two are in the */
  {"jmp", 0x1c000000, 0xfc83fe00, PROPELLER_OPERAND_JMP, NR, PROP_2, NO_COMPRESSED, 0},
...
/* jmpn     000111 zc0i cccc --------- sssssssss */
  {"jmpn", 0x1c000000, 0xfc800000, PROPELLER_OPERAND_JMPRET, NR, PROP_2, NO_COMPRESSED, 0},
...
/* ret      000111 zc01 cccc --------- --------- *//* wrong order either way */
  {"ret", 0x1c400000, 0xfcc00000, PROPELLER_OPERAND_NO_OPS, NR, PROP_2, NO_COMPRESSED, 0},
...
/* jmpret   000111 zc1i cccc ddddddddd sssssssss *//* these, */
  {"jmpret", 0x1c800000, 0xfc800000, PROPELLER_OPERAND_JMPRET, R, PROP_2, NO_COMPRESSED, 0},
...
/* call     000111 zc11 cccc DDDDDDDDD sssssssss *//* too. */
  {"call", 0x1c000000, 0xfc000000, PROPELLER_OPERAND_CALL, R, PROP_2, NO_COMPRESSED, 0},

/* jmpd      010111 zc0i cccc --------- sssssssss *//* These two are in the */
  {"jmpd", 0x5c000000, 0xfc83fe00, PROPELLER_OPERAND_JMP, NR, PROP_2, NO_COMPRESSED, 0},
/* jmpnd     010111 zc0i cccc --------- sssssssss */
  {"jmpnd", 0x5c000000, 0xfc800000, PROPELLER_OPERAND_JMPRET, NR, PROP_2, NO_COMPRESSED, 0},
/* retd      010111 zc01 cccc --------- --------- *//* wrong order either way */
  {"retd", 0x5c400000, 0xfcc00000, PROPELLER_OPERAND_NO_OPS, NR, PROP_2, NO_COMPRESSED, 0},
/* jmpretd   010111 zc1i cccc ddddddddd sssssssss *//* these, */
  {"jmpretd", 0x5c800000, 0xfc800000, PROPELLER_OPERAND_JMPRET, R, PROP_2, NO_COMPRESSED, 0},
/* calld     010111 zc11 cccc DDDDDDDDD sssssssss *//* too. */
  {"calld", 0x5c000000, 0xfc000000, PROPELLER_OPERAND_CALL, R, PROP_2, NO_COMPRESSED, 0},

/* test     011000 zcRi cccc ddddddddd sssssssss */
  {"test", 0x60000000, 0xfc800000, PROPELLER_OPERAND_TWO_OPS, NR, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* and      011000 zcri cccc ddddddddd sssssssss */
  {"and", 0x60000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, COMPRESS_XOP, XOP_AND},
/* andn     011001 zcri cccc ddddddddd sssssssss */
  {"andn", 0x64000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, COMPRESS_XOP, XOP_ANDN},
/* or       011010 zcri cccc ddddddddd sssssssss */
  {"or", 0x68000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, COMPRESS_XOP, XOP_OR},
/* xor      011011 zcri cccc ddddddddd sssssssss */
  {"xor", 0x6c000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, COMPRESS_XOP, XOP_XOR},
/* muxc     011100 zcri cccc ddddddddd sssssssss */
  {"muxc", 0x70000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* muxnc    011101 zcri cccc ddddddddd sssssssss */
  {"muxnc", 0x74000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* muxz     011110 zcri cccc ddddddddd sssssssss */
  {"muxz", 0x78000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* muxnz    011111 zcri cccc ddddddddd sssssssss */
  {"muxnz", 0x7c000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* add      100000 zcri cccc ddddddddd sssssssss */
  {"add", 0x80000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, COMPRESS_XOP, XOP_ADD},
/* cmp      100001 zc0i cccc ddddddddd sssssssss */
  {"cmp", 0x84000000, 0xfc800000, PROPELLER_OPERAND_TWO_OPS, NR, PROP_1 | PROP_2, COMPRESS_XOP, XOP_CMPU},
/* sub      100001 zc1i cccc ddddddddd sssssssss */
  {"sub", 0x84800000, 0xfc800000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, COMPRESS_XOP, XOP_SUB},
/* addabs   100010 zcri cccc ddddddddd sssssssss */
  {"addabs", 0x88000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* subabs   100011 zcri cccc ddddddddd sssssssss */
  {"subabs", 0x8c000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* sumc     100100 zcri cccc ddddddddd sssssssss */
  {"sumc", 0x90000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* sumnc    100101 zcri cccc ddddddddd sssssssss */
  {"sumnc", 0x94000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* sumz     100110 zcri cccc ddddddddd sssssssss */
  {"sumz", 0x98000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* sumnz    100111 zcri cccc ddddddddd sssssssss */
  {"sumnz", 0x9c000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* mov      101000 zcri cccc ddddddddd sssssssss */
  {"mov", 0xa0000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, COMPRESS_MOV, PREFIX_MVIB},
/* mova is like mov, but it assumes the immediate operand is a cog address */
/* mova      101000 zcri cccc ddddddddd sssssssss */
  {"mova", 0xa0000000, 0xfc000000, PROPELLER_OPERAND_MOVA, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* neg      101001 zcri cccc ddddddddd sssssssss */
  {"neg", 0xa4000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, COMPRESS_XOP, XOP_NEG},
/* abs      101010 zcri cccc ddddddddd sssssssss */
  {"abs", 0xa8000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* absneg   101011 zcri cccc ddddddddd sssssssss */
  {"absneg", 0xac000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* negc     101100 zcri cccc ddddddddd sssssssss */
  {"negc", 0xb0000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* negnc    101101 zcri cccc ddddddddd sssssssss */
  {"negnc", 0xb4000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* negz     101110 zcri cccc ddddddddd sssssssss */
  {"negz", 0xb8000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* negnz    101111 zcri cccc ddddddddd sssssssss */
  {"negnz", 0xbc000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* cmps     110000 zcRi cccc ddddddddd sssssssss */
  {"cmps", 0xc0000000, 0xfc800000, PROPELLER_OPERAND_TWO_OPS, NR, PROP_1 | PROP_2, COMPRESS_XOP, XOP_CMPS},
/* cmpsx    110001 zcRi cccc ddddddddd sssssssss */
  {"cmpsx", 0xc4000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, NR, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* addx     110010 zcri cccc ddddddddd sssssssss */
  {"addx", 0xc8000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* cmpx     110011 zc0i cccc ddddddddd sssssssss */
  {"cmpx", 0xcc000000, 0xfc800000, PROPELLER_OPERAND_TWO_OPS, NR, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* subx     110011 zc1i cccc ddddddddd sssssssss */
  {"subx", 0xcc800000, 0xfc800000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* adds     110100 zcri cccc ddddddddd sssssssss */
  {"adds", 0xd0000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* subs     110101 zcri cccc ddddddddd sssssssss */
  {"subs", 0xd4000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
/* addsx    110110 zcri cccc ddddddddd sssssssss */
  {"addsx", 0xd8000000, 0xfc000000, PROPELLER_OPERAND_TWO_OPS, R, PROP_1 | PROP_2, NO_COMPRESSED, 0},
...
/* waitpeq  111100 zcRi cccc ddddddddd sssssssss */
  {"waitpeq", 0xfe000000, 0xfe800000, PROPELLER_OPERAND_TWO_OPS, NR, PROP_2, NO_COMPRESSED, 0},
