...
START_RELOC_NUMBERS (elf_propeller_reloc_type)
  ...
  RELOC_NUMBER (R_PROPELLER_16, 2)
  RELOC_NUMBER (R_PROPELLER_8, 3)
  RELOC_NUMBER (R_PROPELLER_SRC_IMM, 4)
  RELOC_NUMBER (R_PROPELLER_SRC, 5)
  RELOC_NUMBER (R_PROPELLER_DST, 6)
